...
func (r *TodoItemDb) Create(userID, listID int, item todoapp.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoItemDb) GetAll(userID, listID int) ([]todoapp.TodoItem, error) {
...
func (r *TodoItemDb) GetByID(userID, itemID int) (todoapp.TodoItem, error) {
...
func (r *TodoItemDb) Delete(userID, itemID int) error {
